...
public class Student {
    ...
    public String nextID(){
        ...
        /* Resets the counter when the ID hits the biggest number */
        if (nextId == 10000){
            nextId = 0;
        return this.id;
    }
    ...
    /* MAIN TO TEST IF CLASSES WORK CORRECTLY */
    public static void main (String args[]) {
        
        /* Creating two courses */
        Course c1 = new Course("Programming I", 3, false);
        Course c2 = new Course("Programming II", 3, true);
        
        /* Creating a new Student */
        Student s1 = new Student("Fadi", "Samaaan", "2168178@edu.vaniercollege.qc.ca", 19, c1, c2);
        
        /* Printing all the informations of s1 */
        System.out.println(s1);
        
        /* Creating another student and printing his infos */
        Student s2 = new Student("Yaman", "Alhamamy", "2195286@edu.vaniercollege.qc.ca", 20, c2, c1);
        System.out.println("\n" + s2);
        
        /* Extracting email account from Fadi */
        System.out.println("\nEmail account of s1 : " + s1.extractEmailAccount());
        
        /* Verifying if the email of Yaman is correct */
        System.out.println("\nEmail of s2 is correct? " + s2.isEmailCorrect());
